    ...
    const asset = await prisma.$transaction(async (tx) => {
      ...
      await writeAudit(tx, {
        ...
        before: {
          ...
          functionalStatus: snapshot.functionalStatus,
          notes: snapshot.notes,
          parentAssetId: snapshot.parentAssetId,
        ...
        after: {
          ...
          ram: updated.ram,
          storageCapacity: updated.storageCapacity,
          ...
          salvageValue: updated.salvageValue,
          usefulLifeYears: updated.usefulLifeYears,
          purchaseDate: updated.purchaseDate,
          generalStatus: updated.generalStatus,
          functionalStatus: updated.functionalStatus,
          notes: updated.notes,
          parentAssetId: updated.parentAssetId ?? null,
